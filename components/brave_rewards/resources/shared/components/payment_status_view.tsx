...
interface RewardsAmountProps {
  amount: number
}

function RewardAmount (props: RewardsAmountProps) {
  return (
        ...
        <div>
          {
            formatMessage(getString('rewardsPaymentPending'), [
              <RewardAmount key='amount' amount={props.amount} />,
              getPaymentMonth(),
    ...
    return (
      <div className='rewards-payment-completed'>
        ...
        <div>
          ...
          <span className='rewards-payment-not-arrived'>
            {
              formatMessage(getString('rewardsPaymentNotArrived'), {
                tags: {
                  $1: (content) => (
