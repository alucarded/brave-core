...
export const localeStrings = {
  rewardsAdGrantText: 'You earned $1 from viewing Brave Private Ads!',
  rewardsAdGrantTitle: 'Ad earnings received',
  rewardsBraveRewards: 'Brave Rewards',
  rewardsClaimEarnings: 'Claim earnings',
  ...
  rewardsPaymentCompleted: 'Your $1 $2 rewards have arrived!',
  rewardsPaymentPending: 'Your $1 $2 rewards will arrive in $3',
  rewardsPaymentNotArrived: 'Hasn’t arrived yet?  $1Check here$2.',
  ...
  rewardsTokenGrantText: 'Use your promotional tokens to contribute to creators before they expire!',
  rewardsTokenGrantTitle: 'Tokens available'
}
