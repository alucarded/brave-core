            ...
            steps {
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'brave-builds-github-token-for-pr-builder', usernameVariable: 'PR_BUILDER_USER', passwordVariable: 'PR_BUILDER_TOKEN')]) {
                        ...
                        STORYBOOK_PR_URL = prDetails.labels.count { label -> label.name.equalsIgnoreCase('CI/storybook-url') }.equals(1)
                        SKIP_STORYBOOK_PR_URL = prDetails.labels.count { label -> label.name.equalsIgnoreCase('CI/skip-storybook-url') }.equals(1)
                    ...
                    jobDsl(scriptText: """
                        pipelineJob('${PIPELINE_NAME}') {
                            ...
                            parameters {
                                ...
                                booleanParam('STORYBOOK_PR_URL', false)
                                booleanParam('SKIP_STORYBOOK_PR_URL', false)
                    ...
                    params = [
                        ...
                        booleanParam(name: 'STORYBOOK_PR_URL', value: STORYBOOK_PR_URL),
                        booleanParam(name: 'SKIP_STORYBOOK_PR_URL', value: SKIP_STORYBOOK_PR_URL),
